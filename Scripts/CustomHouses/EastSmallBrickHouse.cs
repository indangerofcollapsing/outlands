...
{
    public class EastSmallBrickHouse : BaseHouse
    {
        ...
        public EastSmallBrickHouse(Mobile owner): base(0x161, owner, 425, 3)
        {
        ...
        public EastSmallBrickHouse(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            return new EastSmallBrickHouseDeed();
        }
