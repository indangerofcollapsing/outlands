...
public class EmailCommands
{
    public static void Initialize()
    {
        ...
        //Admin Commands
		CommandSystem.Register("EmailPlayer", AccessLevel.GameMaster, new CommandEventHandler(On_Email));
		//CommandSystem.Register("SendMassEmail", AccessLevel.Administrator, new CommandEventHandler(Send_Email));
		//CommandSystem.Register("clearemails", AccessLevel.GameMaster, new CommandEventHandler(Clear_Emails));
    }
    ...
    public static void On_Login(LoginEventArgs e)
    {
		...
		// TEMP UNTIL WE VERIFIED EMAILING WORKS
