...
namespace Server.Gumps
{
	public class AuthGump : Gump
	{
            ...
            : base(0, 0)
		{
			...
			AddBackground(145, 150, 365, 223, 83);
			AddLabel(220, 157, 53, "Confirm Email Registration");

			AddHtml(155, 184, 347, 119, "Enter the 10 character long verification code that was emailed to you.\nIf you have logged out since submitting your email address, the verification code has expired and you will need to submit your request again.", true, false);

			AddLabel(158, 310, 53, "Enter Here:");
			AddAlphaRegion( 247, 308, 255, 25 );
            AddTextEntry(247, 308, 255, 25, 40, 2, "");

			AddButton( 223, 340, 4005, 4006, 1, GumpButtonType.Reply, 0);
			AddLabel(258, 342, 53, "Submit");
		}
                ...
                case 1:
                    {
                        ...
                        if (CanValidate(s, key, from))
                        {
                            ...
                            string msg = "Your email address is now registered and you will be able to receive special announcements via email.\nYou will also be able to use it as reference in case of account fraud or lost password.\n\n\nThank you,\nThe UOAC Dev Team";

                            EmailEventArgs eea = new EmailEventArgs(true, null, email, "Email Registered", msg);
                            
                            RegisterEmailClient.SendMail(eea);
                            from.SendMessage("Thank you for registering your email address.");
                        }
                        else
                        {
