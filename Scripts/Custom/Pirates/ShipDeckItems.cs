...
namespace Server.Items
{
    public static class ShipDeckItems
    {
            ...
            if (boat.MobileControlType == MobileControlType.Player)
            {
                ...
                for (int a = 0; a < deckItems; a++)
                {
                    ...
                    switch (themUpgrade.Theme)
                    {
                        ...
                        case Theme.GhostShip: item = GetRandomGhostShipItem(); break;
            ...
            else
            {
                for (int a = 0; a < deckItems; a++)
                {
                    ...
                    switch (boat.MobileFactionType)
                    {
                        ...
                        case MobileFactionType.Undead: item = GetRandomGhostShipItem(); break;
                    }
        ...
        public static Item GetRandomGhostShipItem()
        {
            List<Item> m_Items = new List<Item>();
