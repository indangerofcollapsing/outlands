...
namespace Server.Items
{
    ...
    public class PirateStuddedGloves : BaseArmor
    {
        ...
        [Constructable]
        public PirateStuddedGloves(): base(0x13D5)
        {
            Weight = 1.0;
            Name = "Pirate Studded Gloves";
        ...
        public PirateStuddedGloves(Serial serial): base(serial)
        {
        }
