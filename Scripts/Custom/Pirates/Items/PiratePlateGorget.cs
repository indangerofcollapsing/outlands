...
{
    public class PiratePlateGorget : BaseArmor
    {
        ...
        [Constructable]
        public PiratePlateGorget(): base(0x1413)
        {
            Weight = 2.0;
            Name = "Pirate Plate Gorget";
        ...
        public PiratePlateGorget(Serial serial): base(serial)
        {
        }
