...
namespace Server.Items
{
    ...
    public class PirateRingmailChest : BaseArmor
    {
        ...
        [Constructable]
        public PirateRingmailChest(): base(0x13EC)
        {
            Weight = 8.0;            
            Name = "Pirate Ringmail Chest";
        ...
        public PirateRingmailChest(Serial serial): base(serial)
        {
        }
