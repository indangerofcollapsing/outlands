...
{
    public class PirateStuddedGorget : BaseArmor
    {
        ...
        [Constructable]
        public PirateStuddedGorget(): base(0x13D6)
        {
            Weight = 1.0;
            Name = "Pirate Studded Gorget";
        ...
        public PirateStuddedGorget(Serial serial): base(serial)
        {
        }
