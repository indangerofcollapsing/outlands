...
namespace Server.Gumps
{
	public class WelcomeGump : Gump
	{
		...
		public String electionStatus(Town town)
		{
			var electionState = town.Election.State;
			var election = town.Election;
                ...
                case ElectionState.Pending:
                    {
                        ...
                        if (days > 0)
                            return String.Format("{0} days until the next campaign period.", days.ToString());
                        else
                            return String.Format("{0} hours until the next campaign period.", hours.ToString());
                        break;
                    }
                case ElectionState.Campaign:
                    {
                        return "Election campaigning in progress.";
                        break;
                    }
                case ElectionState.Election: 
                    {
                        return "Voting currently in progress.";
                        break;
                    }
                case ElectionState.Announced:
                    {
                        ...
                        if (hours > 0)
                            ...
                            return String.Format("{0} minutes until the next campaign period.", minutes.ToString());
                        break;
                    }
                case ElectionState.Starting:
                    {
                        ...
                        if (minutes > 0)
                            ...
                            return "Election Campaining has begun.";
