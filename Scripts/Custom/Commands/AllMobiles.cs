...
namespace Server.Gumps
    {
    public class AllMobilesGump : Gump
        {
        public static void Initialize()
            {
            CommandSystem.Register( "AllMobiles", AccessLevel.Developer, new CommandEventHandler( AllMobiles_OnCommand ) );
            }
        ...
        private static void AllMobiles_OnCommand( CommandEventArgs e )
            {
            e.Mobile.SendGump( new AllMobilesGump( e.Mobile ) );
            }
        ...
        public AllMobilesGump( Mobile owner ) : this( owner, BuildList( owner ), 0 )
            {
            }

        public AllMobilesGump( Mobile owner, List<Mobile> items, int page ) : base( GumpOffsetX, GumpOffsetY )
            {
            owner.CloseGump( typeof( AllMobilesGump ) );
        ...
        public override void OnResponse( NetState state, RelayInfo info )
            ...
            switch( info.ButtonID )
                ...
                case 1: // Previous 
                    {
                    if( m_Page > 0 )
                        from.SendGump( new AllMobilesGump( from, m_Mobiles, m_Page - 1 ) );
                ...
                default:
                    ...
                    if( index >= 0 && index < m_Mobiles.Count )
                        ...
                        if( s.Deleted )
                            ...
                            from.SendGump( new AllMobilesGump( from, m_Mobiles, m_Page ) );
                            }
                        else
                            {
                            if( deleting )
        ...
        private class DeleteGump : Gump
            ...
            public override void OnResponse( Server.Network.NetState sender, RelayInfo info )
                ...
                m_From.SendGump( new AllMobilesGump( m_From, m_Mobiles, 0 ) );
