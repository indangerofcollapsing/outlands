...
namespace Server.Gumps
    {
    public class AllStrandedItemGump : Gump
        {
        public static void Initialize()
            {
            CommandSystem.Register( "StrandedItems", AccessLevel.Developer, new CommandEventHandler( StrandedItems_OnCommand ) );
            }
        public static string m_args;
        [Usage( "StrandedItems" )]
        [Description( "Lists all items." )]
        private static void StrandedItems_OnCommand( CommandEventArgs e )
            {
            e.Mobile.SendGump( new AllStrandedItemGump( e.Mobile ) );
            }
        ...
        public AllStrandedItemGump( Mobile owner )
            : this( owner, BuildList( owner ), 0 )
            {
            }

        public AllStrandedItemGump( Mobile owner, List<Item> items, int page )
            : base( GumpOffsetX, GumpOffsetY )
            {
            owner.CloseGump( typeof( AllStrandedItemGump ) );
                ...
                default:
                        ...
                        if( index >= 0 && index < m_Items.Count )
                            ...
                            if( s.Deleted )
                                ...
                                from.SendGump( new AllStrandedItemGump( from, m_Items, m_Page ) );
                                }
                            else if( deleting )
        ...
        private class DeleteItemGump : Gump
            ...
            public override void OnResponse( Server.Network.NetState sender, RelayInfo info )
                ...
                m_From.SendGump( new AllStrandedItemGump( m_From, m_Items, 0 ) );
                }
            }
