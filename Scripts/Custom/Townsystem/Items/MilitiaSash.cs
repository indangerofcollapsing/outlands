...
{
    public class MilitiaSash : BodySash
    {
        public override string DefaultName { get { return "a militia sash"; } }
        ...
        [Constructable]
        public MilitiaSash(Town town)
        {
            Town = town;
            LootType = Server.LootType.Newbied;
        }

        public MilitiaSash(Serial serial)
            : base(serial)
        {
        }
