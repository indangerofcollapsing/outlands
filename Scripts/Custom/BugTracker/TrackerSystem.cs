...
namespace Server.Engines.Tracker
{
	...
	public class TrackerSystem
	{
		...
		public static void Configure()
		{
            ...
            RegisterMember(1, "Jimmy");
            RegisterMember(2, "Luthius");
            RegisterMember(3, "Patt");
            RegisterMember(4, "Abigor");
		...
		public static void Initialize()
		{
			...
			{
				CommandSystem.Register( "AddIssue",  AccessLevel.Counselor, new CommandEventHandler( OnCommand_AddIssue ) );
				CommandSystem.Register( "ViewIssues", AccessLevel.GameMaster, new CommandEventHandler( OnCommand_ViewIssues ) );
				
				CommandSystem.Register( "RemoveIssue", AccessLevel.Administrator, new CommandEventHandler( OnCommand_RemoveIssue ) );
			
				Utility.PushColor( ConsoleColor.Cyan );
                Console.WriteLine("Bug Tracker System: Monitoring {1} Issues", SystemVersion, TrackerPersistance.AllIssues == null ? 0 : TrackerPersistance.AllIssues.Count);
				Utility.PopColor();
			}
		}
