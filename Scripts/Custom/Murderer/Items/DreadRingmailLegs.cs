...
namespace Server.Items
{
    ...
    public class DreadRingmailLegs : BaseArmor
    {
        ...
        [Constructable]
        public DreadRingmailLegs(): base(0x13F0)
        {
            Weight = 7.0;
            Name = "Dread Ringmail Legs";       
        ...
        public DreadRingmailLegs(Serial serial): base(serial)
        {
        }
