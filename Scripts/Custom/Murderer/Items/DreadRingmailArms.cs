...
namespace Server.Items
{
    ...
    public class DreadRingmailArms : BaseArmor
    {
        ...
        [Constructable]
        public DreadRingmailArms(): base(0x13EE)
        {
            Weight = 3.0;
            Name = "Dread Ringmail Arms";
        ...
        public DreadRingmailArms(Serial serial) : base(serial)
        {
        }
