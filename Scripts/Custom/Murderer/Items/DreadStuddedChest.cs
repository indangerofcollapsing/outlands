...
namespace Server.Items
{
    ...
    public class DreadStuddedChest : BaseArmor
    {
        ...
        [Constructable]
        public DreadStuddedChest(): base(0x13DB)
        {
            Weight = 8.0;            
            Name = "Dread Studded Chest";
        ...
        public DreadStuddedChest(Serial serial): base(serial)
        {
        }
