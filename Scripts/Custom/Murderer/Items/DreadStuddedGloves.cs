...
namespace Server.Items
{
    ...
    public class DreadStuddedGloves : BaseArmor
    {
        ...
        [Constructable]
        public DreadStuddedGloves(): base(0x13D5)
        {
            Weight = 1.0;
            Name = "Dread Studded Gloves";
        ...
        public DreadStuddedGloves(Serial serial): base(serial)
        {
        }
