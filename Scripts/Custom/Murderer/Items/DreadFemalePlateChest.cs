...
namespace Server.Items
{
    ...
    public class DreadFemalePlateChest : BaseArmor
    {
        ...
        [Constructable]
        public DreadFemalePlateChest(): base(0x1c04)
        {
            Weight = 10.0;            
            Name = "Dread Female Plate Chest";
        ...
        public DreadFemalePlateChest(Serial serial): base(serial)
        {
        }
