...
{
    public class ConchShell : AquariumItem
    {
        public override string DescriptionA { get { return "A Conch Shell"; } }
        ...
        public override int ItemId { get { return 4039; } }
        public override int ItemHue { get { return 2600; } }

        [Constructable]
        public ConchShell(): base()
        {
            Name = "a conch shell";    
