...
{
    public class SunkenArmor : AquariumItem
    {
        public override string DescriptionA { get { return "Sunken Armor"; } }
        ...
        public override int ItemId { get { return 15785; } }
        public override int ItemHue { get { return 2600; } }

        [Constructable]
        public SunkenArmor(): base()
        {
            Name = "sunken armor";    
        ...
        public SunkenArmor(Serial serial): base(serial)
        {
        }
