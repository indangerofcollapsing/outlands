...
{
    public class SeaVines : AquariumItem
    {
        public override string DescriptionA { get { return "Sea Vines"; } }
        ...
        public override int ItemId { get { return 3392; } }
        public override int ItemHue { get { return 2600; } }

        [Constructable]
        public SeaVines(): base()
        {
            Name = "sea vines";    
        ...
        public SeaVines(Serial serial): base(serial)
        {
        }
