...
{
    public class VioletZebrafish : AquariumItem
    {        
        public override string DescriptionA { get { return "A Violet Zebrafish"; } }
        ...
        public override int ItemId { get { return 15114; } }
        ...
        [Constructable]
        public VioletZebrafish(): base()
        {
            Name = "a violet zebrafin";
        }

        public VioletZebrafish(Serial serial): base(serial)
        {
        }
