...
namespace Server.Items
{
    ...
    public class PaladinChainChest : BaseArmor
    {
        ...
        [Constructable]
        public PaladinChainChest(): base(0x13BF)
        {
            Weight = 7.0;            
            Name = "Paladin Chain Chest";
        ...
        public PaladinChainChest(Serial serial): base(serial)
        {
        }
