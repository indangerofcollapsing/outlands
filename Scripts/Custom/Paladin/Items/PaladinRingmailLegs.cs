...
namespace Server.Items
{
    ...
    public class PaladinRingmailLegs : BaseArmor
    {
        ...
        [Constructable]
        public PaladinRingmailLegs(): base(0x13F0)
        {
            Weight = 7.0;
            Name = "Paladin Ringmail Legs";       
        ...
        public PaladinRingmailLegs(Serial serial): base(serial)
        {
        }
