...
{
	public class PaladinMageGorget : BaseArmor
	{
		...
		[Constructable]
		public PaladinMageGorget() : base( 0x13C7 )
		{
			Weight = 1.0;            
            Name = "Paladin Mage Gorget";
        ...
        public PaladinMageGorget(Serial serial): base(serial)
		{
		}
