...
namespace Server.Items
{
    ...
    public class PaladinRingmailChest : BaseArmor
    {
        ...
        [Constructable]
        public PaladinRingmailChest(): base(0x13EC)
        {
            Weight = 8.0;            
            Name = "Paladin Ringmail Chest";
        ...
        public PaladinRingmailChest(Serial serial): base(serial)
        {
        }
