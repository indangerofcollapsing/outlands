...
namespace Server.Items
{
    ...
    public class PaladinStuddedChest : BaseArmor
    {
        ...
        [Constructable]
        public PaladinStuddedChest(): base(0x13DB)
        {
            Weight = 8.0;            
            Name = "Paladin Studded Chest";
        ...
        public PaladinStuddedChest(Serial serial): base(serial)
        {
        }
