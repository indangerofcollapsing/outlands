...
namespace Server.Items
{
    ...
    public class PaladinStuddedArms : BaseArmor
    {
        ...
        [Constructable]
        public PaladinStuddedArms(): base(0x13DC)
        {
            Weight = 4.0;
            Name = "Paladin Studded Arms";
        ...
        public PaladinStuddedArms(Serial serial) : base(serial)
        {
        }
