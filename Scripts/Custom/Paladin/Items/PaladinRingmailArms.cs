...
namespace Server.Items
{
    ...
    public class PaladinRingmailArms : BaseArmor
    {
        ...
        [Constructable]
        public PaladinRingmailArms(): base(0x13EE)
        {
            Weight = 3.0;
            Name = "Paladin Ringmail Arms";
        ...
        public PaladinRingmailArms(Serial serial) : base(serial)
        {
        }
