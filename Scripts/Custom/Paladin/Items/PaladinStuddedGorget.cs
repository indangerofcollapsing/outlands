...
{
    public class PaladinStuddedGorget : BaseArmor
    {
        ...
        [Constructable]
        public PaladinStuddedGorget(): base(0x13D6)
        {
            Weight = 1.0;
            Name = "Paladin Studded Gorget";
        ...
        public PaladinStuddedGorget(Serial serial): base(serial)
        {
        }
