...
namespace Server.Items
{
    ...
    public class PaladinFemalePlateChest : BaseArmor
    {
        ...
        [Constructable]
        public PaladinFemalePlateChest(): base(0x1c04)
        {
            Weight = 10.0;            
            Name = "Paladin Female Plate Chest";
        ...
        public PaladinFemalePlateChest(Serial serial): base(serial)
        {
        }
