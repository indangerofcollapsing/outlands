...
namespace Server.Items
{
    ...
    public class PaladinRingmailGloves : BaseArmor
    {
        ...
        [Constructable]
        public PaladinRingmailGloves(): base(0x13EB)
        {
            Weight = 2.0;
            Name = "Paladin Ringmail Gloves";
        ...
        public PaladinRingmailGloves(Serial serial): base(serial)
        {
        }
