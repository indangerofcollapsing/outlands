...
{
    public class UOACZScavengeOreSpawner : UOACZSpawner
    {
        public static List<UOACZScavengeOreSpawner> m_Spawners = new List<UOACZScavengeOreSpawner>();
        ...
        [Constructable]
        public UOACZScavengeOreSpawner(): base()
        {
            Name = "Scavenge Ore Spawner";
        ...
        public UOACZScavengeOreSpawner(Serial serial): base(serial)
        {
        }
