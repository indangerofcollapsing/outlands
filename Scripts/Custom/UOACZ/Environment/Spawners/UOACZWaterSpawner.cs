...
{
    public class UOACZWaterSpawner : UOACZSpawner
    {
        public static List<UOACZWaterSpawner> m_Spawners = new List<UOACZWaterSpawner>();

        public List<Item> m_Items = new List<Item>();

        [Constructable]
        public UOACZWaterSpawner(): base()
        {
            Name = "Water Spawner";
        ...
        public UOACZWaterSpawner(Serial serial): base(serial)
        {
        }
        ...
        public override void Spawn(Point3D point, Map map)
        {
            ...
            {
                case 1: itemType = typeof(UOACZWater); break;
            }

            if (itemType != null)
            {
                UOACZWater item = (UOACZWater)Activator.CreateInstance(itemType);
