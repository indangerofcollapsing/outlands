...
{
    public class UOACZNorthSouthPalisadeLeftDoor : UOACZBreakableDoor
    {
        public override int OverrideNormalItemId { get { return 1690; } }
        ...
        [Constructable]
        public UOACZNorthSouthPalisadeLeftDoor(): base()
        {
            Name = "door";
        ...
        public UOACZNorthSouthPalisadeLeftDoor(Serial serial): base(serial)
        {
        }
