...
{
    public class UOACZEastWestWallTurret : UOACZBreakableStatic
    {
        public override int OverrideNormalItemId { get { return 13887; } }
        ...
        [Constructable]
        public UOACZEastWestWallTurret(): base()
        {
            Name = "wall";
        }

        public UOACZEastWestWallTurret(Serial serial): base(serial)
        {
        }
