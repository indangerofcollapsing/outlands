...
{
    public class UOACZNorthSouthWallTurret : UOACZBreakableStatic
    {
        public override int OverrideNormalItemId { get { return 13886; } }
        ...
        [Constructable]
        public UOACZNorthSouthWallTurret(): base()
        {
            Name = "wall";
        }

        public UOACZNorthSouthWallTurret(Serial serial): base(serial)
        {
        }
