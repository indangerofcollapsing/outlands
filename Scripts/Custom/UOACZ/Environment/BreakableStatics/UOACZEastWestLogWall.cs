...
{
    public class UOACZEastWestLogWall : UOACZBreakableStatic
    {
        public override int OverrideNormalItemId { get { return 146; } }
        public override int OverrideNormalHue { get { return 0; } }

        public override int OverrideLightlyDamagedItemId { get { return 156; } }
        ...
        [Constructable]
        public UOACZEastWestLogWall(): base()
        {
            Name = "wall";
        ...
        public UOACZEastWestLogWall(Serial serial): base(serial)
        {
        }
