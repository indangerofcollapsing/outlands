...
namespace Server
{
    public class UOACZCorruptionStone : Item
    {
        ...
        [Constructable]
        public UOACZCorruptionStone(): base(22336)
        {
            Name = "a corruption stone";
        }

        [Constructable]
        public UOACZCorruptionStone(PlayerMobile player): base(22336)
        {
            Name = "a corruption stone";
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            UOACZSystem.ChangeStat(player, UOACZSystem.UOACZStatType.CorruptionPoints, 1, true);
        ...
        public UOACZCorruptionStone(Serial serial): base(serial)
        {
        }
