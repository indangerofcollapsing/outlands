...
{            
    public class UOACZLesserConfusionPotion: BasePotion
    {
        [Constructable]
        public UOACZLesserConfusionPotion(): base(3846, PotionEffect.Custom)
        {
            Name = "a lesser confusion potion";
            Hue = 2960;
        ...
        public UOACZLesserConfusionPotion(Serial serial): base(serial)
        {
        }       
