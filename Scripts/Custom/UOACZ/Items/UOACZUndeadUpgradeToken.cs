...
namespace Server
{
    public class UOACZUndeadUpgradeToken : Item
    {
        ...
        [Constructable]
        public UOACZUndeadUpgradeToken(): base(6935)
        {
            Name = "an undead upgrade token";
            Hue = 2577;
        }

        [Constructable]
        public UOACZUndeadUpgradeToken(PlayerMobile player): base(6935)
        {
            Name = "an undead upgrade token";
            Hue = 2577;
        ...
        public UOACZUndeadUpgradeToken(Serial serial): base(serial)
        {
        }
