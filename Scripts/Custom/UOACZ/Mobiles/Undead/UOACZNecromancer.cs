...
namespace Server
{
    ...
    public class UOACZNecromancer : UOACZBaseUndead
	{
        ...
        {
            SetSubGroup(AISubgroup.GroupHealerMage1);
            UpdateAI(false);
        ...
        public UOACZNecromancer(Serial serial): base(serial)
		{
		}
