...
namespace Server.Custom.Misc.CustomizableVendor
{
    public class Currency : Item
    {
        ...
        public Currency(Payment type)
        {
            if (type == Payment.ByTreasuryKeys)
            {
                m_Payment = type;
                m_Payment_Type = typeof(PlayerMobile);
                m_PropertyInfo = null;
                m_ItemID = 4114;
                m_Name = "Treasury Keys";
            }
        }
        ...
        public void Charge(Mobile m, int cost)
        {
            if (m is PlayerMobile)
            {
                ...
                if (pm.TreasuryKeys >= cost)
                    pm.TreasuryKeys -= cost;
            }
        }
        ...
        public int Value(Mobile m)
        {
            switch (m_Payment)
            {
                ...
                case Payment.ByTreasuryKeys:
                    return ProcessByTreasuryKeys(m);
            }
            return 0;
        }

        public int ProcessByTreasuryKeys(Mobile m)
        {
            var pm = m as PlayerMobile;
    ...
    public class Reward : Item, ICloneable
    {
        ...
        public bool DyeTownColor { get { return m_DyeTownColor; } set { m_DyeTownColor = value; } }
        ...
        public void Edit(int cost, string title, string desc, bool dyed)
        {
        ...
        public override void Serialize(GenericWriter writer)
        {
            ...
            writer.Write((int)2);
            writer.Write((bool)m_DyeTownColor);
        ...
        public override void Deserialize(GenericReader reader)
        {
            ...
            switch (version)
            {
                case 2:
                    {
                        m_DyeTownColor = reader.ReadBool();
                        goto case 1;
                    }
                case 1:
                    {
    ...
    public class EditItemGump : Gump
    {
            ...
            : base(0, 0)
        {
            ...
            AddLabel(258, 80, 2124, @"Dye Town Color");
        ...
        public void InitialText()
        {
            ...
            AddCheck(500, 75, 9720, 9724, m_Reward.DyeTownColor, 3);
        }
        public void PacketText()
        {
            ...
            AddCheck(500, 75, 9720, 9724, (bool)m_Entries[3], 3);               //dye town color
        }
        ...
        public Storage GetEntries(RelayInfo info)
        {
            ...
            //Dye Town color
            bool dyed = info.IsSwitched(3);

            return new Storage(desc, costtext, name, dyed);
        }
                ...
                case 1: //ok
                    {
                        try
                        {
                            ...
                            m_Reward.Edit(cost, name, desc, dyed);
                            ...
                            if (curr.Purchase(m, m_Reward.Cost))
                            {
                                ...
                                if (m_Reward.DyeTownColor)
                                {
                                    ...
                                    if (pm != null)
                                    {
                                        ...
                                        if (town != null)
                                        {
                                            if (i is MilitiaTotem)
                                            {
                                                ((MilitiaTotem)i).Town = town;
                                            }
                                            else
                                            {
                                                int hue = town.HomeFaction.Definition.HuePrimary;
                                                if (i is DyeTub)
                                                    ((DyeTub)i).DyedHue = hue;
                                                i.Hue = hue;
                                            }
                                        }
                                    }
    ...
    public class ControlPanelGump : Gump
    {
            ...
            : base(0, 0)
        {
            ...
            AddLabel(51, 415, 43, @"Treasury Keys");
            AddRadio(15, 408, 9720, 9724, false, 9);
                ...
                case 3: //Payment
                    {
                        ...
                        try
                        {
                            ...
                            else if (info.IsSwitched(9)) //consume treasury keys
                            {
                                m_Vendor.Payment = new Currency(Server.Custom.Misc.CustomizableVendor.Currency.Payment.ByTreasuryKeys);
                                m.SendMessage("{0} will now use Treasury Keys for payment.", m_Vendor.GetName());
                                MenuUploader.Display(m_Vendor.Menu, m, m_Vendor, false);
                            }
                            else
                            {
