...
namespace Server.Custom.Donations
{
    public static class Donations
    {
        ...
        public static OrderedDictionary DragonTable = new OrderedDictionary()
        {
            ...
            {
                new DonationItem("Hat Armor Patch", "Patches any hat to have exceptional leather cap AR equivalent. <b>Named hats will lose their name</b>.", 0x0376, 0, 175, false, typeof(HatArmorPatch)),
            ...
            new List<DonationItem>()
            {
                ...
                new DonationItem("Cloth Folding Contraption", "Tired of looking at ugly cut clothes? This contraption can help you fold them neatly!", 11005, 2502, 1500, false, typeof(ClothFoldingContraption)),
        ...
        public static void PurchaseItem(Mobile from, DonationItem di, DonationShop gump)
        {
            ...
            if (newObj != null)
            {
                ...
                else if (newItem is IDWand)
                {
                    ((IDWand)newItem).Charges = 100;
                }
