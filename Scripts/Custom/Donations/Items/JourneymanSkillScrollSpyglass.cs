...
{
    public class JourneymanSkillScrollSpyglass : Item
    {
        public override string DefaultName
        {
            get
            {
                return "Journeyman Skill Scroll Spyglass";
            }
        }
        ...
        [Constructable]
        public JourneymanSkillScrollSpyglass()
            : base(5365)
        {
            m_Charges = 50;
        ...
        public JourneymanSkillScrollSpyglass(Serial serial)
            : base(serial)
        {
        }
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            from.SendMessage("Target the monster you wish to increase the skill scroll drop rate for? (Only works for skills below 70)");
        ...
        public void UseCharge(Mobile from, BaseCreature creature)
        {
            ...
            creature.JourneymanDropIncrease *= 3;
            m_Charges--;
        ...
        {
            JourneymanSkillScrollSpyglass m_Spyglass;

            public InternalTarget(JourneymanSkillScrollSpyglass spyglass)
