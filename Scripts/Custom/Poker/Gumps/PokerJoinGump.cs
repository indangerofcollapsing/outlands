...
namespace Server.Poker
{
	public class PokerJoinGump : Gump
	{
			...
			: base( 50, 50 )
		{
            ...
            this.AddLabel(125, 10, 28, @"UOAC's Texas Hold-em");
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
            ...
            else if (WindFragment.ExistsOn(from))
            {
                from.SendMessage("You cannot do that while carrying the Wind Fragment."); // You can't do that while carrying the sigil.
                return;
            }
