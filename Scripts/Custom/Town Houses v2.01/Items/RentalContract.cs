...
namespace Knives.TownHouses
{
	public class RentalContract : TownHouseSign
	{
		...
		public void DepositTo( Mobile m )
		{
			...
			m.BankBox.DropItem( new DragonCoin( Price ) );
			m.SendMessage( "You have received a {0} dragon coins deposit from your town house.", Price );
		}
		...
		protected override void OnRentPaid()
		{
			...
			c_RentalMaster.BankBox.DropItem( new DragonCoin( Price ) );
