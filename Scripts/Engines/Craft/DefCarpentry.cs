...
namespace Server.Engines.Craft
{
    public class DefCarpentry : CraftSystem
    {
        ...
        public override void InitCraftList()
        {
            ...
            if (Core.SE)
            {
                index = AddCraft(typeof(Bokuto), Core.ML ? 1044566 : 1044295, 1030227, 70.0, 95.0, typeof(Board), 1044041, 6, 1044351);
                SetNeededExpansion(index, Expansion.SE);

                index = AddCraft(typeof(Fukiya), Core.ML ? 1044566 : 1044295, 1030229, 60.0, 85.0, typeof(Board), 1044041, 6, 1044351);
                SetNeededExpansion(index, Expansion.SE);

                index = AddCraft(typeof(Tetsubo), Core.ML ? 1044566 : 1044295, 1030225, 80.0, 140.3, typeof(Board), 1044041, 10, 1044351);
                SetNeededExpansion(index, Expansion.SE);
            }
