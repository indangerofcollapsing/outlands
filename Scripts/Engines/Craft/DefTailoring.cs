...
namespace Server.Engines.Craft
{
	public class DefTailoring : CraftSystem
	{
		...
		public override void InitCraftList()
		{
            ...
            //Luthius Expansion            
            index = AddCraft(typeof(SpidersilkFishingNet), 1015283, "spidersilk fishing net", 80.0, 120.0, typeof(Cloth), 1044286, 50, 1044287);
			...
			AddCraft( typeof( StuddedGorget ), 1015300, 1025078, 60, 90, typeof( Leather ), 1044462, 6, 1044463 );
			AddCraft( typeof( StuddedGloves ), 1015300, 1025077, 55, 85, typeof( Leather ), 1044462, 8, 1044463 );
			AddCraft( typeof( StuddedArms ), 1015300, 1025076, 65, 95, typeof( Leather ), 1044462, 10, 1044463 );
			AddCraft( typeof( StuddedLegs ), 1015300, 1025082, 65, 95, typeof( Leather ), 1044462, 12, 1044463 );
			AddCraft( typeof( StuddedChest ), 1015300, 1025083, 75, 105, typeof( Leather ), 1044462, 14, 1044463 );
			...
			AddCraft( typeof( StuddedBustierArms ), 1015306, 1027180, 70, 100, typeof( Leather ), 1044462, 8, 1044463 );
			AddCraft( typeof( FemaleLeatherChest ), 1015306, 1027174, 62.2, 87.2, typeof( Leather ), 1044462, 8, 1044463 );
			AddCraft( typeof( FemaleStuddedChest ), 1015306, 1027170, 70, 100, typeof( Leather ), 1044462, 10, 1044463 );
			#endregion
			...
			index = AddCraft(typeof(OrcHelm), 1049149, 1027947, 60, 90, typeof(Leather), 1044462, 6, 1044463);
			AddRes(index, typeof(Bone), 1049064, 4, 1049063);
			#endregion

            //Ship Items
            index = AddCraft(typeof(BoardingRope), "Ship Equipment", "boarding rope", 50, 75, typeof(Cloth), "cloth", 25, "You do not have the neccesary cloth to construct a boarding rope.");
