...
namespace Server.Engines.Craft
{
    public class DefTinkering : CraftSystem
    {
        ...
        public override void InitCraftList()
        {
            ...
            AddCraft(typeof(Shovel), 1044046, 1023898, 37.5, 90.0, typeof(IronIngot), 1044036, 4, 1044037);
            ...
            AddCraft(typeof(Nails), 1044047, "nails", 0.0, 25.0, typeof(IronIngot), 1044036, 2, 1044037);
            ...
            AddCraft(typeof(Scales), 1044050, 1026225, 60.0, 130.0, typeof(IronIngot), 1044036, 4, 1044037);
            ...
            AddCraft(typeof(Spyglass), 1044050, 1025365, 60.0, 130.0, typeof(IronIngot), 1044036, 4, 1044037);
            ...
            // Poison Trap
            index = AddCraft(typeof(PoisonTrapCraft), "Traps and Bombs", 1044593, 30.0, 80.0, typeof(IronIngot), 1044036, 1, 1044037);
            AddRes(index, typeof(BasePoisonPotion), 1044571, 1, 1044253);

            // Explosion Trap
            index = AddCraft(typeof(ExplosionTrapCraft), "Traps and Bombs", 1044597, 55.0, 105.0, typeof(IronIngot), 1044036, 1, 1044037);
            AddRes(index, typeof(BaseExplosionPotion), 1044569, 1, 1044253);

            #endregion

            //Ship Items
            index = AddCraft(typeof(BagOfCannonShot), "Ship Equipment", "bag of cannon shot", 50, 60, typeof(IronIngot), "iron ingot", 50, "You do not have the neccesary ingots to construct a bag of cannon shot.");
