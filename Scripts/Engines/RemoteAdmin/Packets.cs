...
namespace Server.RemoteAdmin
{
	...
	public sealed class ServerInfo : Packet
	{
		public ServerInfo() : base( 0x04 )
		{
			...
			m_Stream.Write( (int) NetStateCount() );
        ...
        public static bool SpoofPlayerCount = true;

        public static int NetStateCount()
        {
            int count = 0;
	...
	public sealed class CompactServerInfo : Packet
	{
		public CompactServerInfo() : base( 0x51 )
		{
			...
			m_Stream.Write( (int) ServerInfo.NetStateCount() - 1 );                      // Clients
