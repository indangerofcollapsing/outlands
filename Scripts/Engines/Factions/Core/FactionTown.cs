...
namespace Server.Factions
{
	...
	public abstract class FactionTown : IComparable
	{
		private TownDefinition m_Definition;
		private FactionTownState m_State;
		...
		public static FactionTown FromRegion( Region reg )
		{
			if ( reg.Map != Faction.Facet )
				return null;

			List<FactionTown> towns = Towns;
		...
		public FactionTown()
		{
			m_State = new FactionTownState( this );
		...
		public static List<FactionTown> Towns { get { return Reflector.Towns; } }
		...
		{
			return m_Definition.Sort - ((FactionTown)obj).m_Definition.Sort;
		}
		...
		public static void WriteReference( GenericWriter writer, FactionTown town )
		{
		...
		public static FactionTown ReadReference( GenericReader reader )
		{
		...
		public static FactionTown Parse( string name )
		{
			List<FactionTown> towns = Towns;
		...
		{
			FactionTown town = FromRegion( e.Mobile.Region );
