...
namespace Server.Engines.ConPVP
{
    ...
    public class DuelContext
    {
        ...
        public bool AllowItemUse(Mobile from, Item item)
        {
            ...
            if (item is BasePotion)
            {
                ...
                if (item is BaseAgilityPotion)
                    ...
                    option = "Heal";
                else if (item is LesserMagicResistPotion)
                    option = "Magic Resist";
        ...
        public void Requip(Mobile from, Container cont)
        {
            ...
            if (corpse.ItemID == 0x2006)
            {
                ...
                if (killer != null && killer.Player)
                    killer.AddToBackpack(new Head(m_Tournament == null ? HeadType.Duel : HeadType.Tournament, from));
            }
        ...
        private static void EventSink_Speech(SpeechEventArgs e)
        {
            ...
            //}
            /*else*/
            if (Insensitive.Equals(e.Speech, "showladder"))
            {
                e.Blocked = true;
                if (!pm.CheckAlive())
                {
