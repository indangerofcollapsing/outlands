			...
			get
			{
				if ( m_Root == null )
				{
					...
					if( !Core.AOS )
					{
						...
						#region Order
						Ruleset order = new Ruleset( m_Root );

						order.Title = "Order";

						order.SetOptionRange( "Spells", true );

						order.SetOption( "Spells", "Wall of Stone", false );
						order.SetOption( "Spells", "Fire Field", false );
						order.SetOption( "Spells", "Poison Field", false );
						order.SetOption( "Spells", "Energy Field", false );
						order.SetOption( "Spells", "Teleport", false );
						order.SetOption( "Spells", "Wall of Stone", false );
						order.SetOption( "Spells", "Arch Protection", false );
						order.SetOption( "Spells", "Recall", false );
						order.SetOption( "Spells", "Blade Spirits", false );
						order.SetOption( "Spells", "Incognito", false );
						order.SetOption( "Spells", "Magic Reflection", false );
						order.SetOption( "Spells", "Paralyze", false );
						order.SetOption( "Spells", "Summon Creature", false );
						order.SetOption( "Spells", "Invisibility", false );
						order.SetOption( "Spells", "Mark", false );
						order.SetOption( "Spells", "Paralyze Field", false );
						order.SetOption( "Spells", "Energy Field", false );
						order.SetOption( "Spells", "Gate Travel", false );
						order.SetOption( "Spells", "Polymorph", false );
						order.SetOption( "Spells", "Energy Vortex", false );
						order.SetOption( "Spells", "Air Elemental", false );
						order.SetOption( "Spells", "Summon Daemon", false );
						order.SetOption( "Spells", "Earth Elemental", false );
						order.SetOption( "Spells", "Fire Elemental", false );
						order.SetOption( "Spells", "Water Elemental", false );
						order.SetOption( "Spells", "Earthquake", false );
						order.SetOption( "Spells", "Meteor Swarm", false );
						order.SetOption( "Spells", "Chain Lightning", false );
						order.SetOption( "Spells", "Resurrection", false );

						order.SetOptionRange( "Combat Abilities", true );

						order.SetOption( "Skills", "Anatomy", true );
						order.SetOption( "Skills", "Detect Hidden", true );
						order.SetOption( "Skills", "Evaluating Intelligence", true );

						order.SetOptionRange( "Weapons", true );
						order.SetOption( "Weapons", "Magical", false );
						order.SetOption( "Weapons", "Poisoned", false );
						order.SetOptionRange( "Armor", true );
						order.SetOption( "Armor", "Magical", false );

						order.SetOption( "Potions", "Refresh", true );
						order.SetOption( "Items", "Bandages", true );
						#endregion

						#region Chaos
						Ruleset chaos = new Ruleset( m_Root );

						chaos.Title = "Chaos";

						chaos.SetOptionRange( "Spells", true );

						chaos.SetOptionRange( "Combat Abilities", true );

						chaos.SetOptionRange( "Skills", true );
						chaos.SetOption( "Skills", "Stealing", false );

						chaos.SetOptionRange( "Weapons", true );
						chaos.SetOptionRange( "Armor", true );

						chaos.SetOptionRange( "Potions", true );
						chaos.SetOptionRange( "Items", true );
						#endregion

						m_Root.Defaults = new Ruleset[] { m5x, m7x, s7x, order, chaos };
					}
					else
					{
