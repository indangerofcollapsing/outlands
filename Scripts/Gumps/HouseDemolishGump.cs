				...
				if ( m_House.IsOwner( m_Mobile ) )
				{
					...
					else
					{
						...
						if ( toGive != null )
						{
                            ...
                            {
                                if (m_Mobile.Backpack.TryDropItem(m_Mobile, toGive, false))
                                {
                                    m_Mobile.SendLocalizedMessage(501391); //You place the deed in your backpack.
                                    m_House.RemoveKeys(m_Mobile);
                                    m_House.Delete();
                                }
                                else
                                {
                                    m_Mobile.SendLocalizedMessage(501390); //You do not have room in your backpack for a house deed.
                                    toGive.Delete();
                                }
                            }
						}
