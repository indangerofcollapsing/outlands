...
{
    public class AdeptSkillScrollSpyglass : Item
    {
        public override string DefaultName
        {
            get
            {
                return "Adept Skill Scroll Spyglass";
            }
        }
        ...
        [Constructable]
        public AdeptSkillScrollSpyglass()
            : base(5365)
        {
            m_Charges = 25;
        ...
        public AdeptSkillScrollSpyglass(Serial serial)
            : base(serial)
        {
        }
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            from.SendMessage("Target the monster you wish to increase the skill scroll drop rate for? (Only works for skills below 90)");
        ...
        public void UseCharge(Mobile from, BaseCreature creature)
        {
            ...
            creature.AdeptDropIncrease *= 6.5;
            m_Charges--;
        ...
        {
            AdeptSkillScrollSpyglass m_Spyglass;

            public InternalTarget(AdeptSkillScrollSpyglass spyglass)
