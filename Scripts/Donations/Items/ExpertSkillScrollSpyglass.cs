...
{
    public class ExpertSkillScrollSpyglass : Item
    {
        public override string DefaultName
        {
            get
            {
                return "Expert Skill Scroll Spyglass";
            }
        }
        ...
        [Constructable]
        public ExpertSkillScrollSpyglass()
            : base(5365)
        {
            m_Charges = 15;
        ...
        public ExpertSkillScrollSpyglass(Serial serial)
            : base(serial)
        {
        }
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            from.SendMessage("Target the monster you wish to increase the skill scroll drop rate for? (Only works for skills below 80)");
        ...
        {
            ExpertSkillScrollSpyglass m_Spyglass;

            public InternalTarget(ExpertSkillScrollSpyglass spyglass)
