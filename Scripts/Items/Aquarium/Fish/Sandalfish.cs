...
{
    public class Sandalfish : AquariumItem
    {        
        public override string DescriptionA { get { return "A Sandalfish"; } }
        ...
        public override int ItemId { get { return 15115; } }
        ...
        [Constructable]
        public Sandalfish(): base()
        {
            Name = "a sandalfish";
        }

        public Sandalfish(Serial serial): base(serial)
        {
        }
