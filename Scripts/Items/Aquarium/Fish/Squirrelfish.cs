...
{
    public class Squirrelfish : AquariumItem
    {        
        public override string DescriptionA { get { return "A Squirrelfish"; } }
        ...
        public override int ItemId { get { return 15104; } }
        ...
        [Constructable]
        public Squirrelfish(): base()
        {
            Name = "a squirrelfish";
        }

        public Squirrelfish(Serial serial): base(serial)
        {
        }
