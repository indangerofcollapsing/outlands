...
{
    public class SeaGrass : AquariumItem
    {
        public override string DescriptionA { get { return "Sea Grass"; } }
        ...
        public override int ItemId { get { return 3378; } }
        public override int ItemHue { get { return 2600; } }

        [Constructable]
        public SeaGrass(): base()
        {
            Name = "sea grass";    
