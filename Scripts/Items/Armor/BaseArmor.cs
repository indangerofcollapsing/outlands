...
namespace Server.Items
{
    public abstract class BaseArmor : Item, IScissorable, IFactionItem, ICraftable, IWearableDurability
    {
                ...
                case 0:
                    {
                        ...
                        else
                        {
                            ...
                            switch (reader.ReadInt())
                            {
                                ...
                                case 9: info = OreInfo.Lunite; break;
                            }
        ...
        {
            double HalfAr = ArmorRating * ArmorScalar / 2.0;
            ...
            //Slayer armor is subjected to durability reduction even if it's blessed in dungeon.
            if (Parent is Mobile && CheckBlessed(((Mobile)Parent)) && !(this is BaseDungeonArmor))
                return damageTaken;

            if (0.25 > Utility.RandomDouble())// 25% chance to lower durability
            {
                int wear;
