...
{
    public class SkillScrollSpyglass : Item
    {
        ...
        public override string DefaultName
        {
            get
            {
                return "Apprentice Skill Scroll Spyglass";
            }
        }
        ...
        public SkillScrollSpyglass(Serial serial)
            : base(serial)
        {
        }
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            from.SendMessage("Target the monster you wish to increase the skill scroll drop rate for? (Only works for skills below 60)");
        ...
        public void UseCharge(Mobile from, BaseCreature creature)
        {
            ...
            creature.ApprenticeDropIncrease *= 2.5;
            m_Charges--;
        ...
        {
            SkillScrollSpyglass m_Spyglass;

            public InternalTarget(SkillScrollSpyglass spyglass)
