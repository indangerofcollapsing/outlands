...
namespace Server.Items
{
    ...
    public abstract class TrapableContainer : BaseContainer, ITelekinesisable
    {
        ...
        public virtual TrapType TrapType
        {
            get
            {
                return m_TrapType;
        ...
        protected void SendMessageTo(Mobile to, string text, int hue)
        {
            if (Deleted || !to.CanSee(this))
                return;
        ...
        public virtual void OnTelekinesis(Mobile from)
        {
            ...
            if (!ExecuteTrap(from)) //!this.TrapOnOpen || 
                base.DisplayTo(from);
        }
