...
namespace Server.Items
{
	...
	{ 
        ...
        [Constructable]
        public WoodenTreasureChest(int level)
            : base(0xE43, (TreasureLevel)level)
        {
        }
	...
	public class MetalGoldenTreasureChest : BaseTreasureChest 
	{
        ...
        [Constructable]
        public MetalGoldenTreasureChest(int level)
            : base(0xE41, (TreasureLevel)level)
        {
        } 
	...
	public class MetalTreasureChest : BaseTreasureChest 
	{
        ...
        [Constructable]
        public MetalTreasureChest(int level)
            : base(0x9AB, (TreasureLevel)level)
        {
        } 
