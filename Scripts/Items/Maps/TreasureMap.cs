...
namespace Server.Items
{
	public class TreasureMap : MapItem
	{
		...
		private static Type[][] m_SpawnTypes = new Type[][]
		{
			...
			new Type[]{ typeof(LichLord), typeof(Daemon), typeof(BloodElemental), typeof(GreaterCyclops), typeof(CoreHound), typeof(SanguinWizard), typeof(WhiteWyrm), typeof(IceFiend) },
