...
namespace Server.Items
{
    public class BallOfSummoning : Item, TranslocationItem
    {
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            if (SpellHelper.IsFireDungeon(from.Map, from.Location))
            {
        ...
        public void CastSummonPet(Mobile from)
        {
            ...
            else if (from.Region is BattlegroundRegion || from.Map == Map.Ilshenar || from.Region.IsPartOf(typeof(DungeonRegion)) || from.Region.IsPartOf(typeof(Jail)) || from.Region.IsPartOf(typeof(Server.Engines.ConPVP.SafeZone)))
            {
