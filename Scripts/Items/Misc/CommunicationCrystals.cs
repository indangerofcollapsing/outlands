...
namespace Server.Items
{
	...
	public class BroadcastCrystal : Item
	{
        ...
        public AccessLevel m_SpeechAccessLevel = AccessLevel.Player;
        [CommandProperty(AccessLevel.GameMaster)]
        public AccessLevel SpeechAccessLevel
        {
            get { return m_SpeechAccessLevel; }
            set { m_SpeechAccessLevel = value; }
        }
		...
		public override void Serialize( GenericWriter writer )
		{
            ...
            //Version 1
            writer.Write((int)SpeechAccessLevel);
		}
		...
		public override void Deserialize( GenericReader reader )
		{
            ...
            if (version >= 1)
            {
                m_SpeechAccessLevel = (AccessLevel)reader.ReadInt();
            }
		}
	}
