...
{
    public class FishPie : Food
    {
        public override string DisplayName { get { return "fish pie"; } }
        ...
        public override int IconItemHue { get { return 2653; } }
        ...
        [Constructable]
        public FishPie(): base(4161)
        {
            Name = "fish pie";
            Hue = 2653;
        }

        public FishPie(Serial serial): base(serial)
        {
        }
