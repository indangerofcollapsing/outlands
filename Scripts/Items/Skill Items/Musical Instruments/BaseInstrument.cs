...
namespace Server.Items
{
    ...
    public abstract class BaseInstrument : Item, ICraftable, ISlayer
    {
        ...
        private SlayerName m_Slayer, m_Slayer2, m_TempSlayer;
        ...
        public static double ExceptionalQualitySkillBonus = 10;
        public static double SlayerSkillBonus = 20;
        ...
        public double GetBonusesFor(Mobile target)
        {
            double bonusValue = 0;
            ...
            if (m_Slayer != SlayerName.None)
            {
                ...
                if (entry != null)
                {
                    if (entry.Slays(target))
                        bonusValue += SlayerSkillBonus;
                }
            }
