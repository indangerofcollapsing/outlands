	...
	public class Scissors : Item
	{
		...
		private class InternalTarget : Target
		{
			...
			protected override void OnTarget( Mobile from, object targeted )
			{
                ...
                {
                    PowerScroll powerscroll = targeted as PowerScroll;

                    if (player != null)
                    {
                        player.CloseGump(typeof(ConvertPowerscrollDeedGump));
                        player.SendGump(new ConvertPowerscrollDeedGump(powerscroll, player));
                    }
                }
