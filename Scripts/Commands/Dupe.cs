	...
	public class Dupe
	{
        ...
        private class DupeTarget : Target
        {
            ...
            protected override void OnTarget(Mobile from, object targ)
            {
                ...
                XmlSpawner XMLSpawnerInstance = copy as XmlSpawner;

                if (XMLSpawnerInstance != null)
                {
                    if (XMLSpawnerInstance.WayPoint != null)
                    {
                        from.SendMessage("You cannot dupe a XMLSpawner with an active waypont.");
                        return;
                    }
                }
