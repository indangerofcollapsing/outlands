...
{
	public class RegionGoldMod
	{
        private static Dictionary<Region, double> m_Modifiers = new Dictionary<Region, double>();

		public static void Initialize()
		{
            CommandSystem.Register("RegionGoldMod", AccessLevel.Seer, new CommandEventHandler(RegionGoldMod_OnCommand));
		}
        ...
        [Usage("RegionGoldMod (optional:<region> <mod>)")]
        [Description("Sets a gold modifier for a specific region.")]
        public static void RegionGoldMod_OnCommand(CommandEventArgs e)
		{
            ...
            if (e.Length == 0)
            {
                ...
                sb.Append("<BASEFONT COLOR=WHITE>MODIFIED GOLD REGIONS<br><br>");
            ...
            if (e.Length == 2)
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        from.SendMessage(String.Format("The gold modifier for \"{0}\" has been set to {1}", region.Name, mod));
                    }
                }
                catch
                {
                    from.SendMessage("Error in arguments. Usage: [RegionGoldMod \"name\" <mod>");
                }
            }
		}
