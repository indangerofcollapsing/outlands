...
{
    public class RegionSkillscrollMod
    {
        ...
        [Usage("RegionSkillscrollMod (optional:<region> <mod>)")]
        [Description("Sets a skill scroll modifier for a specific region.")]
        public static void RegionSkillscrollMod_OnCommand(CommandEventArgs e)
        {
            ...
            if (e.Length == 0)
            {
                ...
                sb.Append("<BASEFONT COLOR=WHITE>MODIFIED SKILLSCROLL REGIONS<br><br>");
            ...
            if (e.Length == 2)
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        from.SendMessage(String.Format("The skill scroll modifier for \"{0}\" has been set to {1}", region.Name, mod));
                    }
                }
                catch
                {
                    from.SendMessage("Error in arguments. Usage: [RegionSkillscrollMod \"name\" <mod>");
                }
            }
        }
