...
namespace Server.Engines.Craft
{
    ...
    public class CraftItem
    {
        ...
        private static int[] m_HeatSources = new int[]
			{
                ...
                0x2352, 0x2360 //hearth of the Home
			};
        ...
        public static bool RetainsColor(Type type)
        {
            ...
            //Check if the item is a furniture, if so, then it should retains the resource color
            inItemTable = inItemTable || type.IsDefined(typeof(FurnitureAttribute), false);
