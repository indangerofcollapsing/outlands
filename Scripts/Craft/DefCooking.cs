...
namespace Server.Engines.Craft
{
    public class DefCooking : CraftSystem
    {
        ...
        public override void InitCraftList()
        {
            ...
            index = AddCraft(typeof(FishSteak), 1044498, 1022427, 0.0, 120.0, typeof(RawFishSteak), 1044476, 1, 1044253);
            SetNeedHeat(index, true);
            SetUseAllRes(index, true);

            index = AddCraft(typeof(FishSteak), 1044498, "fish steak (single)", 0.0, 120.0, typeof(RawFishSteak), 1044476, 1, 1044253);
            SetNeedHeat(index, true);
            ...
            index = AddCraft(typeof(Ribs), 1044498, 1022546, 0.0, 120.0, typeof(RawRibs), 1044485, 1, 1044253);
            SetNeedHeat(index, true);
            SetUseAllRes(index, true);
            ...
            //Luthius Expansion            
            index = AddCraft(typeof(FaintLure), "Specialty Items", "Faint Lure", 40, 80, typeof(RawFishSteak), "Raw Fish Steak", 100, "You do not have the neccessary raw fish steaks required to cook this.");
            AddRes(index, typeof(CockatriceEgg), "Cockatrice Egg", 1, "You do not have the neccesary crafting component needed to make this");

            index = AddCraft(typeof(PotentLure), "Specialty Items", "Potent Lure", 60, 100, typeof(RawFishSteak), "Raw Fish Steak", 150, "You do not have the neccessary raw fish steaks required to cook this.");
            AddRes(index, typeof(CockatriceEgg), "Cockatrice Egg", 1, "You do not have the neccesary crafting component needed to make this");

            index = AddCraft(typeof(IrresistibleLure), "Specialty Items", "Irresistable Lure", 80, 120, typeof(RawFishSteak), "Raw Fish Steak", 200, "You do not have the neccessary raw fish steaks required to cook this.");
            AddRes(index, typeof(CockatriceEgg), "Cockatrice Egg", 1, "You do not have the neccesary crafting component needed to make this");

            //Kin Paints
            index = AddCraft(typeof(TribalKinPaint), "Kin Paints", "tribal kin paint", 60.0, 65.0, typeof(Bloodroot), "bloodroot", 1, "You do not have the neccessary bloodroot required to cook this.");
            SetNeedHeat(index, true);

            index = AddCraft(typeof(DrowKinPaint), "Kin Paints", "drow kin paint", 60.0, 65.0, typeof(StrangeMushrooms), "strange mushrooms", 1, "You do not have the neccessary strange mushrooms required to cook this.");
            SetNeedHeat(index, true);

            index = AddCraft(typeof(UndeadKinPaint), "Kin Paints", "undead kin paint", 60.0, 65.0, typeof(Bonemeal), "bonemeal", 1, "You do not have the neccessary bonemeal required to cook this.");
            SetNeedHeat(index, true);

            index = AddCraft(typeof(GreenOrcKinPaint), "Kin Paints", "green orc kin paint", 60.0, 65.0, typeof(CaveMoss), "cave moss", 1, "You do not have the neccessary cave moss required to cook this.");
            SetNeedHeat(index, true);
