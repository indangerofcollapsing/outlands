...
namespace Server.Engines.Craft
{
    public class DefCooking : CraftSystem
    {
        ...
        public override void InitCraftList()
        {
            ...
            //Ingredients
            index = AddCraft(5, typeof(Dough), "Ingredients", "Dough", -25.0, 25.0, typeof(SackOfFlour), "Sack of Flour", 1, missingIngredients);
            AddRes(index, typeof(BaseBeverage), "Water", 1, missingIngredients);
            SetNeedHeat(index, true);

            //Meagre Food
            index = AddCraft(1, typeof(BreadRoll), "Meagre Food", "Bread Roll", -0.1, 100.0, typeof(Dough), "Dough", 1, missingIngredients);
            AddRes(index, typeof(BaseBeverage), "Water", 1, missingIngredients);
            SetNeedHeat(index, true);

            index = AddCraft(1, typeof(CookedEggs), "Meagre Food", "Cooked Eggs", -0.1, 100.0, typeof(Eggs), "Eggs", 3, missingIngredients);
            SetNeedHeat(index, true);

            index = AddCraft(1, typeof(CookedRibs), "Meagre Food", "Cooked Ribs", -0.1, 100.0, typeof(RawRibs), "Raw Ribs", 1, missingIngredients);
            SetNeedHeat(index, true);

            index = AddCraft(1, typeof(CookedFishsteak), "Meagre Food", "Cooked Fishsteak", -0.1, 100.0, typeof(RawFishSteak), "Raw Fishsteak", 1, missingIngredients);
            SetNeedHeat(index, true);            

            index = AddCraft(1, typeof(GardenSalad), "Meagre Food", "Garden Salad", -0.1, 100.0, typeof(Lettuce), "Lettuce", 1, missingIngredients);
            AddRes(index, typeof(Carrot), "Carrot", 1, missingIngredients);
            AddRes(index, typeof(Turnip), "Turnip", 1, missingIngredients);
            SetNeedHeat(index, true);

            index = AddCraft(1, typeof(FruitDish), "Meagre Food", "Fruit Dish", -0.1, 100.0, typeof(Pear), "Pear", 1, missingIngredients);
            AddRes(index, typeof(Grapes), "Grapes", 1, missingIngredients);
            AddRes(index, typeof(Honeydew), "Honeydew", 1, missingIngredients);
            SetNeedHeat(index, true);

            //Adequate Food
            index = AddCraft(1, typeof(CookedDrumstick), "Adequate Food", "Cooked Drumstick", -0.1, 100.0, typeof(RawDrumstick), "Raw Drumstick", 1, missingIngredients);
            SetNeedHeat(index, true);

            index = AddCraft(1, typeof(CookedSteaks), "Adequate Food", "Cooked Steaks", 50.0, 120.0, typeof(RawSteaks), "Raw Steaks", 1, missingIngredients);
            SetNeedHeat(index, true);
            
            index = AddCraft(1, typeof(CookedHam), "Adequate Food", "Cooked Ham", 50.0, 120.0, typeof(RawHam), "Raw Ham", 1, missingIngredients);
            SetNeedHeat(index, true);
            
            index = AddCraft(1, typeof(CookedBird), "Adequate Food", "Cooked Bird", 50.0, 120.0, typeof(RawBird), "Raw Bird", 1, missingIngredients);
            SetNeedHeat(index, true);
            
            index = AddCraft(1, typeof(CookedFishFillet), "Adequate Food", "Cooked Fish Fillet", 50.0, 120.0, typeof(RawFishFillet), "Raw Fish Fillet", 1, missingIngredients);
            SetNeedHeat(index, true);
            
            index = AddCraft(1, typeof(CookedLobster), "Adequate Food", "Cooked Lobster", 50.0, 120.0, typeof(RawLobster), "Raw Lobster", 1, missingIngredients);
            SetNeedHeat(index, true);
            
            index = AddCraft(1, typeof(CookedCrab), "Adequate Food", "Cooked Crab", 50.0, 120.0, typeof(RawCrab), "Raw Crab", 1, missingIngredients);
            SetNeedHeat(index, true);
            
            index = AddCraft(1, typeof(CookedMeatShank), "Adequate Food", "Cooked Meat Shank", 50.0, 120.0, typeof(RawMeatShank), "Raw Meat Shank", 1, missingIngredients);
            SetNeedHeat(index, true);
            
            index = AddCraft(1, typeof(CookedBacon), "Adequate Food", "Cooked Bacon", 50.0, 120.0, typeof(RawBacon), "Raw Bacon", 1, missingIngredients);
            SetNeedHeat(index, true);
            
            index = AddCraft(1, typeof(CookedSausage), "Adequate Food", "Cooked Sausage", 50.0, 120.0, typeof(RawSausage), "Raw Sausage", 1, missingIngredients);
            SetNeedHeat(index, true);
            
            index = AddCraft(1, typeof(SearedMushrooms), "Adequate Food", "Seared Mushrooms", 50.0, 120.0, typeof(WildMushroom), "Wild Mushroom", 1, missingIngredients);
            SetNeedHeat(index, true);
