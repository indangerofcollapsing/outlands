...
namespace Server.Engines.Chat
{
	public class Channel
	{
		...
		public List<ChatUser> m_Users, m_Banned, m_Moderators, m_Voices;
		...
		public void SendIgnorableMessage( int number, ChatUser from, string param1, string param2 )
		{
            ...
            foreach (PlayerSquelchEntry entry in ChatPersistance.m_PlayersSquelched)
            {
                ...
                if (entry.m_Player.Account == null) continue;
            ...
            for (int a = 0; a < m_Users.Count; ++a)
            {
                ...
                if (otherPlayer.NetState == null) continue;                

                ChatPersistance.CheckAndCreateWorldChatAccountEntry(otherPlayer);

                if (!otherPlayer.m_WorldChatAccountEntry.Enabled) continue;
                if (ChatPersistance.IsPlayerSquelched(player, otherPlayer)) continue;
