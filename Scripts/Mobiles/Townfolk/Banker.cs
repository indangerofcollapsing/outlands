...
namespace Server.Mobiles
{
    public class Banker : BaseVendor
    {
        ...
        public static bool CanDepositUniqueCurrency(Mobile from, Type currencyType, int amount)
        {
            ...
            if (amountRemaining > 0)
            {
                ...
                int bankSpaceRemaining = bankBox.MaxItems - bankBox.Items.Count;
