...
namespace Server.Mobiles
{
	public class ArcherGuard : BaseGuard
	{
		...
		public ArcherGuard( Mobile target ) : base( target )
		{
			...
			//SArrow arrows = new Arrow( 250 );

			//arrows.LootType = LootType.Newbied;

			//pack.DropItem( arrows );
			//Spack.DropItem( new Gold( 250, 500 ) );
            ...
            this.LastSwingTime = DateTime.UtcNow + TimeSpan.FromMilliseconds(500);
			this.Focus = target;
		}
		...
		//	private bool m_Shooting;
			...
			{
                return (m_Owner.LastSwingTime - DateTime.UtcNow) > TimeSpan.FromSeconds(1.0); 
			}
