...
{
    [CorpseName("a massive bot corpse")]
    public class DeDOSMassiveBot : BaseCreature
    {
        ...
        [Constructable]
        public DeDOSMassiveBot() : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Name = "a massive bot";
        ...
        public override void OnGaveMeleeAttack(Mobile defender)
        {
            ...
            if (Utility.RandomDouble() <= .05 && !isExploding)
            {
                isExploding = true;
                ...
                Timer.DelayCall(TimeSpan.FromSeconds(Utility.RandomMinMax(1, 3)), delegate
                {
                    ...
                    SpecialAbilities.AnimalExplosion(null, Location, Map, null, Utility.RandomMinMax(5, 6), 20, 30, 5, ExplosionHue, true, true);
            ...
            if (!willKill && amount >= 10)
            {
                if (Utility.RandomDouble() <= .05 && !isExploding)
                {
                    ...
                    Timer.DelayCall(TimeSpan.FromSeconds(Utility.RandomMinMax(1, 3)), delegate
                    {
                        ...
                        SpecialAbilities.AnimalExplosion(null, Location, Map, null, Utility.RandomMinMax(5, 6), 20, 30, 5, ExplosionHue, false, true);
        ...
        public DeDOSMassiveBot(Serial serial) : base(serial) { }        
