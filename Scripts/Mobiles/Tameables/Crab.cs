...
{
    [CorpseName("an crab corpse")]
    public class Crab : BaseCreature
    {
        [Constructable]
        public Crab(): base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Name = "a crab";
            Body = 729;
            Hue = 0;
        ...
        public override int TamedItemId { get { return 17049; } }
