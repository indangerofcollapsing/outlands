...
namespace Server.Items
{
	...
	public class UOACZReinforcedBoneArms : BaseArmor
	{
		...
		[Constructable]
		public UOACZReinforcedBoneArms() : base( 0x144E )
		{
            Name = "reinforced bone arms";
            Hue = 2635;
			Weight = 1.0;
		}

		public UOACZReinforcedBoneArms( Serial serial ) : base( serial )
		{
		}
