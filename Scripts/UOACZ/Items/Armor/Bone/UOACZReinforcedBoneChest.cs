...
namespace Server.Items
{
	...
	public class UOACZReinforcedBoneChest : BaseArmor
	{
		...
		[Constructable]
		public UOACZReinforcedBoneChest() : base( 0x144F )
		{
            Name = "reinforced bone chest";
            Hue = 2635;
			Weight = 6.0;
		}

		public UOACZReinforcedBoneChest( Serial serial ) : base( serial )
		{
		}
