...
namespace Server.Items
{
	...
	public class UOACZReinforcedBoneLegs : BaseArmor
	{
		...
		[Constructable]
		public UOACZReinforcedBoneLegs() : base( 0x1452 )
		{
            Name = "reinforced bone legs";
            Hue = 2635;
			Weight = 3.0;
		}

		public UOACZReinforcedBoneLegs( Serial serial ) : base( serial )
		{
		}
