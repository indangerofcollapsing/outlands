...
namespace Server.Items
{
	...
	public class UOACZReinforcedBoneGloves : BaseArmor
	{
		...
		[Constructable]
		public UOACZReinforcedBoneGloves() : base( 0x1450 )
		{
            Name = "reinforced bone gloves";
            Hue = 2635;
			Weight = 1.0;
		}

		public UOACZReinforcedBoneGloves( Serial serial ) : base( serial )
		{
		}
