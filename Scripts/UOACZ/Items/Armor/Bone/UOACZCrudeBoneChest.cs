...
namespace Server.Items
{
	...
	public class UOACZCrudeBoneChest : BaseArmor
	{
		...
		[Constructable]
		public UOACZCrudeBoneChest() : base( 0x144F )
		{
            Name = "crude bone chest";

			Weight = 6.0;
            Hue = 2955;
		}

		public UOACZCrudeBoneChest( Serial serial ) : base( serial )
		{
		}
