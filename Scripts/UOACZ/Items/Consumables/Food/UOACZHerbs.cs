...
namespace Server.Items
{
    public class UOACZHerbs : UOACZConsumptionItem
    {
        ...
        public UOACZHerbs(Serial serial): base(serial)
        {
        }
