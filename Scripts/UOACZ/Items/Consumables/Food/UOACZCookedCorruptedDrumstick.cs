...
{
    public class UOACZCookedCorruptedDrumstick : UOACZConsumptionItem
    {
        ...
        [Constructable]
        public UOACZCookedCorruptedDrumstick(): base(5640)
        {
            Name = "cooked corrupted drumstick";
            Hue = 2208;
            Weight = 1;
        }
        ...
        public UOACZCookedCorruptedDrumstick(Serial serial): base(serial)
        {
        }
