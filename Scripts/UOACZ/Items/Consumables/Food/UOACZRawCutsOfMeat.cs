...
{
    public class UOACZRawCutsOfMeat : UOACZConsumptionItem
    {
        ...
        [Constructable]
        public UOACZRawCutsOfMeat(): base(7711)
        {
            Name = "raw cuts of meat";
            Hue = 0;
            Weight = 1;
        }
        ...
        public UOACZRawCutsOfMeat(Serial serial): base(serial)
        {
        }
