...
{
    public class UOACZMilitiaArcher : UOACZBaseMilitia
	{
        ...
        [Constructable]
		public UOACZMilitiaArcher() : base()
		{
            Title = "the archer";
            ...
            AddItem(new Boots() { Movable = false, Hue = SecondaryHue });
            AddItem(new LeatherLegs() { Movable = false, Hue = SecondaryHue });
            AddItem(new LeatherChest() { Movable = false, Hue = SecondaryHue });
            AddItem(new LeatherGloves() { Movable = false, Hue = PrimaryHue });            

            AddItem(new Crossbow() { Movable = false, MaxRange = 14, Hue = SecondaryHue });
		}
        ...
        public UOACZMilitiaArcher(Serial serial): base(serial)
		{
		}
