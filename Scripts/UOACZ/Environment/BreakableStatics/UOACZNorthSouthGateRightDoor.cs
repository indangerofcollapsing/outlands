...
{
    public class UOACZNorthSouthGateRightDoor : UOACZBreakableDoor
    {
        public override int OverrideNormalItemId { get { return 13892; } }
        public override int OverrideNormalHue { get { return 2405; } }

        public override int OverrideLightlyDamagedItemId { get { return 13892; } }
        public override int OverrideLightlyDamagedHue { get { return 2405; } }

        public override int OverrideHeavilyDamagedItemId { get { return 13892; } }
        ...
        [Constructable]
        public UOACZNorthSouthGateRightDoor(): base()
        {
            Name = "gate door";
        }

        public UOACZNorthSouthGateRightDoor(Serial serial): base(serial)
        {
        }
