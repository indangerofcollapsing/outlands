...
{
    public class UOACZEastWestPalisadeLeftDoor : UOACZBreakableDoor
    {
        public override int OverrideNormalItemId { get { return 1687; } }
        ...
        [Constructable]
        public UOACZEastWestPalisadeLeftDoor(): base()
        {
            Name = "door";
        ...
        public UOACZEastWestPalisadeLeftDoor(Serial serial): base(serial)
        {
        }
