...
{
    public class UOACZEastWestPalisadeRightDoor : UOACZBreakableDoor
    {
        public override int OverrideNormalItemId { get { return 1685; } }
        ...
        [Constructable]
        public UOACZEastWestPalisadeRightDoor(): base()
        {
            Name = "door";
        ...
        public UOACZEastWestPalisadeRightDoor(Serial serial): base(serial)
        {
        }
