...
{
    public class UOACZEastWestLogRightDoor : UOACZBreakableDoor
    {
        public override int OverrideNormalItemId { get { return 1751; } }
        public override int OverrideNormalHue { get { return 0; } }

        public override int OverrideLightlyDamagedItemId { get { return 2107; } }
        ...
        [Constructable]
        public UOACZEastWestLogRightDoor(): base()
        {
            Name = "door";
        ...
        public UOACZEastWestLogRightDoor(Serial serial): base(serial)
        {
        }
