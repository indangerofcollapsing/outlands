...
{
    public class UOACZScavengeCottonSpawner : UOACZSpawner
    {
        public static List<UOACZScavengeCottonSpawner> m_Spawners = new List<UOACZScavengeCottonSpawner>();
        ...
        [Constructable]
        public UOACZScavengeCottonSpawner(): base()
        {
            Name = "Cotton Scavenge Spawner";
        ...
        public UOACZScavengeCottonSpawner(Serial serial): base(serial)
        {
        }
        ...
        public override void Spawn(Point3D point, Map map)
        {
            ...
            {
                case 1: itemType = typeof(UOACZScavengeCottonPlant); break;
            }

            if (itemType != null)
            {
                UOACZScavengeCottonPlant item = (UOACZScavengeCottonPlant)Activator.CreateInstance(itemType);
