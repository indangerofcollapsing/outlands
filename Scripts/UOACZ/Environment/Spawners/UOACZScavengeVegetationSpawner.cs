...
{
    public class UOACZScavengeVegetationSpawner : UOACZSpawner
    {
        public static List<UOACZScavengeVegetationSpawner> m_Spawners = new List<UOACZScavengeVegetationSpawner>();
        ...
        [Constructable]
        public UOACZScavengeVegetationSpawner(): base()
        {
            Name = "Vegetation Scavenge Spawner";
        ...
        public UOACZScavengeVegetationSpawner(Serial serial): base(serial)
        {
        }
        ...
        public override void Spawn(Point3D point, Map map)
        {
            ...
            {
                case 1: itemType = typeof(UOACZScavengeVegetation); break;
            }

            if (itemType != null)
            {
                UOACZScavengeVegetation item = (UOACZScavengeVegetation)Activator.CreateInstance(itemType);
