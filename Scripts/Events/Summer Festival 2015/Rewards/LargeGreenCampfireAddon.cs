...
{
	public class LargeGreenCampfireAddon : BaseAddon
	{
		...
		public override BaseAddonDeed Deed
		{
			get
			{
				return new LargeGreenCampfireAddonDeed();
			}
		}

		[ Constructable ]
		public LargeGreenCampfireAddon()
		{
			...
			AddComplexComponent( (BaseAddon) this, 6571, 0, 0, 1, 2003, 0, "", 1);// 14
			AddComplexComponent( (BaseAddon) this, 3561, 1, 1, 0, 2005, 0, "", 1);// 22
			AddComplexComponent( (BaseAddon) this, 3561, 1, 0, 7, 2005, 0, "", 1);// 23
			AddComplexComponent( (BaseAddon) this, 3555, 1, 1, 11, 2002, 0, "", 1);// 26
			AddComplexComponent( (BaseAddon) this, 6571, 1, 1, 8, 2003, 0, "", 1);// 27

		}

        public LargeGreenCampfireAddon(Serial serial) : base(serial) {}
	...
	public class LargeGreenCampfireAddonDeed : BaseAddonDeed
	{
		public override BaseAddon Addon
		{
			get
			{
				return new LargeGreenCampfireAddon();
			}
		}

		[Constructable]
		public LargeGreenCampfireAddonDeed()
		{
			Name = "a large green campfire";
		}

		public LargeGreenCampfireAddonDeed( Serial serial ) : base( serial )
		{
		}
