...
{
    public class HenchmanPirateCarpenter : BaseHenchman
	{
		...
		[Constructable]
		public HenchmanPirateCarpenter() : base()
		{
        ...
        public override string TamedDisplayName { get { return "Carpenter"; } }
        ...
        public override void GenerateItems()
        {
            ...
            m_Items.Add(new HalfApron(colorTheme) { LootType = LootType.Blessed });
        ...
        public HenchmanPirateCarpenter(Serial serial): base(serial)
        {
        }    
