...
{
    public class HenchmanMarine : BaseHenchman
	{
        public override string[] recruitSpeech  { get { return new string[] {   "I shall guard the seas under your command.",
                                                                                };
            }
        }
        ...
        public override string[] idleSpeech
        {
            get
            {
                return new string[] {       "The only good pirate is a dead pirate",
                                                                                "We serve the crown",
                                                                                "Duty. Honor. Death",
                                                                                "*scowls*"
                                                                                };
        ...
        public override string[] combatSpeech
        {
            get
            {
                return new string[] {     "You will face justice",
        ...
        public override string TamedDisplayName { get { return "Marine"; } }
        ...
        public override void GenerateItems()
        {
            ...
            switch (Utility.RandomMinMax(1, 4))
            {
                ...
                case 2: { m_Items.Add(new WarMace() { LootType = LootType.Blessed }); m_Items.Add(new MetalShield() { Hue = customTheme, LootType = LootType.Blessed }); break; }                
                case 3: { m_Items.Add(new Bardiche() { LootType = LootType.Blessed }); break; }
        ...
        public HenchmanMarine(Serial serial): base(serial)
        {
        }    
