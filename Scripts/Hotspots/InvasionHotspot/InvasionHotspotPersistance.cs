...
namespace Server
{
    public static class InvasionHotspotPersistance
    {
        public static InvasionHotspotPersistanceItem PersistanceItem;     
        ...
        public static void Initialize()
        {
            Timer.DelayCall(TimeSpan.FromTicks(1), delegate
            {
                if (PersistanceItem == null)
                    PersistanceItem = new InvasionHotspotPersistanceItem();
                ...
                Timer.DelayCall(TimeSpan.FromSeconds(1), delegate
                {
                    if (Enabled)
                    {
                        ...
                        m_Timer = new InvasionHotspotPersistanceTimer();
                        m_Timer.Start();
                    }
                });
            });
        ...
        public class InvasionHotspotPersistanceTimer : Timer
        {
            public InvasionHotspotPersistanceTimer(): base(TimeSpan.Zero, TimeSpan.FromSeconds(5))
            {
            ...
            {
                if (!InvasionHotspotPersistance.Enabled)                
                    return;
        ...
        {
            InvasionHotspotPersistance.m_NextScheduledSessionStartTime = InvasionHotspotPersistance.m_NextScheduledSessionStartTime + ScheduledHotspotInterval;
    ...
    public class InvasionHotspotPersistanceItem : Item
    {
        public override string DefaultName { get { return "InvasionHotspotPersistance"; } }

        public InvasionHotspotPersistanceItem(): base(0x0)
        {
            Movable = false;
        }

        public InvasionHotspotPersistanceItem(Serial serial): base(serial)
        {
        }
        ...
        public override void Serialize(GenericWriter writer)
        {
            ...
            InvasionHotspotPersistance.Serialize(writer);
        }
        ...
        public override void Deserialize(GenericReader reader)
        {
            ...
            InvasionHotspotPersistance.PersistanceItem = this;
            InvasionHotspotPersistance.Deserialize(reader);
        }
    }    
}
