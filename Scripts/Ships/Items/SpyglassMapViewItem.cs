...
namespace Server.Items
{
    ...
    public class SpyglassMapViewItem : Item
	{
		private Rectangle2D m_Bounds;

		private int m_Width, m_Height;
               
        public bool m_Editable = false;
        public bool m_Protected = true;

		public List<Point2D> m_Pins = new List<Point2D>();
        ...
        //public SpyglassMapViewItem(): base(0x14F6)
		[Constructable]        
        public SpyglassMapViewItem(): base(0x14EC)
		{
			Weight = 1.0;            
		...
		public SpyglassMapViewItem( Serial serial ) : base( serial )
		{
		}
		...
		public abstract class MapCommand : Packet
		{
		...
		public class MapDisplay : MapCommand
		{
		...
		public class MapAddPin : MapCommand
		{
		...
		public class MapSetEditable : MapCommand
		{
