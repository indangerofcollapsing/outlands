...
namespace Server.Misc
{
    public class Strandedness
    {
        private static Point2D[] m_Felucca = new Point2D[]
			{
                ...
                new Point2D( 2120, 3616 ), new Point2D( 2136, 3128 ), new Point2D( 2120, 2712 ),
				...
				new Point2D( 1840, 2640 ), new Point2D( 1928, 2952 )
			};

        private static Point2D[] m_TheSecondAge = new Point2D[] 
        {
				new Point2D( 5456, 2400 ), new Point2D( 5976, 2424 ), 
                new Point2D( 5328, 3112 ), new Point2D( 5792, 3152 ), 
        };
        ...
        public static void EventSink_Login(LoginEventArgs e)
        {
            ...
            Point2D[] list;
            if (SpellHelper.IsAnyT2A(map, from.Location))
                list = m_TheSecondAge;
