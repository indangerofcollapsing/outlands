...
{
    public class PirateShipCarpenter : OceanBaseCreature
	{
		...
		[Constructable]
		public PirateShipCarpenter() : base()
		{
            SpeechHue = 0x22;
        ...
        public PirateShipCarpenter(Serial serial): base(serial)
		{
		}
