...
namespace Server.Items
{
	public class CraftAttributeInfo
	{
		...
		public static readonly CraftAttributeInfo DullCopper, ShadowIron, Copper, Bronze, Golden, Agapite, Verite, Valorite, Lunite;
		...
		static CraftAttributeInfo()
		{
            ...
            CraftAttributeInfo lunite = Lunite = new CraftAttributeInfo();

            lunite.ArmorPhysicalResist = 4;
            lunite.ArmorColdResist = 3;
            lunite.ArmorPoisonResist = 3;
            lunite.ArmorEnergyResist = 3;
            lunite.ArmorDurability = 50;
            lunite.WeaponFireDamage = 10;
            lunite.WeaponColdDamage = 20;
            lunite.WeaponPoisonDamage = 10;
            lunite.WeaponEnergyDamage = 20;
            lunite.RunicMinAttributes = 5;
            lunite.RunicMaxAttributes = 5;
            if (Core.ML)
            {
                lunite.RunicMinIntensity = 85;
                lunite.RunicMaxIntensity = 100;
            }
            else
            {
                lunite.RunicMinIntensity = 50;
                lunite.RunicMaxIntensity = 100;
            }
	...
	public class CraftResources
	{
		...
		private static CraftResourceInfo[] m_LeatherInfo = new CraftResourceInfo[]
			{
				...
				new CraftResourceInfo( 2124,  1049354, "Spined",		CraftAttributeInfo.Spined,		CraftResource.SpinedLeather,	typeof( SpinedLeather ),	typeof( SpinedHides ) ),
				new CraftResourceInfo( 1779,  1049355, "Horned",		CraftAttributeInfo.Horned,		CraftResource.HornedLeather,	typeof( HornedLeather ),	typeof( HornedHides ) ),
				new CraftResourceInfo( 1443,  1049356, "Barbed",		CraftAttributeInfo.Barbed,		CraftResource.BarbedLeather,	typeof( BarbedLeather ),	typeof( BarbedHides ) )
			};
		...
		{
			if ( resource >= CraftResource.Iron && resource <= CraftResource.Lunite )
	...
	public class OreInfo
	{
        ...
        public static readonly OreInfo Lunite       = new OreInfo( 9, 2603, "Lunite");
