...
namespace Server.Engines.BulkOrders
{
	...
	public sealed class SmithRewardCalculator : RewardCalculator
	{
        ...
        private static readonly ConstructCallback ArchitectPen = new ConstructCallback( CreateArchitectPen );

		private static Item CreateSturdyShovel( int type )
		{
			return new SturdyShovel(100);
		}

		private static Item CreateSturdyPickaxe( int type )
		{
			return new SturdyPickaxe(100);
		}
		...
		{
			return new GargoylesPickaxe(100);
		}
		...
		{
			if ( type >= 1 && type <= 8 )
				return new RunicHammer( CraftResource.Iron + type, Core.AOS ? ( 55 - (type*5) ) : 20 );
        ...
        private static Item CreateArchitectPen( int type )
        {
            return new ArchitectsPen();
        }
		#endregion
			...
			Groups = new RewardGroup[]
				{
					...
					new RewardGroup(  650, new RewardItem( 1, RunicHammer, 3 ), new RewardItem( 1, ArchitectPen ) ),
	...
	public sealed class TailorRewardCalculator : RewardCalculator
	{
		...
		private static int[][] m_ClothHues = new int[][]
			{
				new int[]{ 2605, 2592, 2580, 2541, 2631 },
				new int[]{ 1196, 2123, 1278, 2212, 1163 }, 
				new int[]{ 1156, 1158, 1761, 2118, 1366 }, 
				new int[]{ 2125, 1109, 1151, 1157, 1373 }, 
				new int[]{ 2710, 2717, 2715, 1269, 1376 }, 
			};
		...
		private static Item CreateCloth( int type )
		{
			...
			{
				UncutCloth cloth = new UncutCloth( 5 );
		...
		private static int[] m_SandalHues = new int[]
			{
				2605, 2592, 2580, 2541, 2631,
				1196, 2123, 1278, 2212, 1163,
				1156, 1158, 1761, 2118, 1366,
				2125, 1109, 1151, 1157, 1373
			};
			...
			Groups = new RewardGroup[]
				{
                    ...
                    new RewardGroup( 350, new RewardItem( 1, Sandals ) ),
					new RewardGroup( 400, new RewardItem( 2, PowerScroll, 5 ), new RewardItem( 3, Tapestry ) ),
					new RewardGroup( 450, new RewardItem( 1, BearRug ), new RewardItem( 1, ArchitectPen ) ),
                    ...
                    new RewardGroup( 600, new RewardItem( 1, Sandals ) ),
					new RewardGroup( 650, new RewardItem( 1, PowerScroll, 20 ) ),
                    //new RewardGroup( 700, new RewardItem( 1, RunicKit, 3 ) )
                    new RewardGroup( 700, new RewardItem( 1, Sandals ), new RewardItem( 1, ClothingBlessDeed ), new RewardItem( 1, Cloth, 4) )
