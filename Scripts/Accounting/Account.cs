...
namespace Server.Accounting
{
    public class Account : IAccount, IComparable, IComparable<Account>
    {
        ...
        private int m_CharacterLimit = 5;

        public Mobile[] accountMobiles { get { return m_Mobiles; } }
        ...
        public static void Initialize()
        {
            ...
            CommandSystem.Register("WipePlayerAccounts", AccessLevel.Administrator, new CommandEventHandler(WipeAllPlayerAccounts_OnCommand));
        }
        ...
        public Account(XmlElement node)
        {
            ...
            m_CharacterLimit = Utility.GetXMLInt32(Utility.GetText(node["characterLimit"], "5"), 5);
        ...
        public void Save(XmlTextWriter xml)
        {
            ...
            xml.WriteStartElement("characterLimit");
            xml.WriteString(XmlConvert.ToString(m_CharacterLimit));
            xml.WriteEndElement();
