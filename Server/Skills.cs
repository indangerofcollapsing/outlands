...
namespace Server
{
	...
	public class SkillInfo
	{
		...
		{
			new SkillInfo( 0, "Alchemy",			        0.0,	0.0,	0.0,	"Alchemist",	    null,	0.0,	0.0,	0.01,	1.0 ),
			new SkillInfo( 1, "Anatomy",			        0.0,	0.0,	0.0,	"Biologist",	    null,	0.005,	0.0,	0.005,	1.0 ),
			new SkillInfo( 2, "Animal Lore",		        0.0,	0.0,	0.0,	"Naturalist",	    null,	0.0,	0.0,	0.01,	1.0 ),
			new SkillInfo( 3, "Item Identification",	    0.0,	0.0,	0.0,	"Merchant",	        null,	0.0,	0.0,	0.01,	1.0 ),
			new SkillInfo( 4, "Arms Lore",			        0.0,	0.0,	0.0,	"Weapon Master",	null,	0.005,	0.005,	0.0,	1.0 ),
			new SkillInfo( 5, "Parrying",			        0.0,	0.0,	0.0,	"Duelist",	        null,	0.01,	0.005,	0.0,	1.0 ),
			new SkillInfo( 6, "Begging",			        0.0,	0.0,	0.0,	"Beggar",	        null,	0.0,	0.005,	0.005,	1.0 ),
			new SkillInfo( 7, "Blacksmithy",		        0.0,	0.0,	0.0,	"Blacksmith",	    null,	0.01,	0.0,	0.0,	1.0 ),
			new SkillInfo( 8, "Bowcraft/Fletching",	        0.0,	0.0,	0.0,	"Bowyer",	        null,	0.005,	0.005,	0.0,	1.0 ),
            new SkillInfo( 9, "Peacemaking",		        0.0,	0.0,	0.0,	"Pacifier",		    null,	0.0,	0.005,	0.005,	1.0 ),
			new SkillInfo( 10, "Camping",			        0.0,	0.0,	0.0,	"Explorer",	        null,	0.1,	0.005,	0.005,	1.0 ),
			new SkillInfo( 11, "Carpentry",			        0.0,	0.0,	0.0,	"Carpenter",	    null,	0.005,	0.005,	0.0,	1.0 ),
			new SkillInfo( 12, "Cartography",		        0.0,	0.0,	0.0,	"Cartographer",	    null,	0.0,	0.0,	0.01,	1.0 ),
			new SkillInfo( 13, "Cooking",			        0.0,	0.0,	0.0,	"Chef",		        null,	0.0,	0.005,	0.005,	1.0 ),
			new SkillInfo( 14, "Detecting Hidden",	        0.0,	0.0,	0.0,	"Scout",	        null,	0.0,	0.005,	0.005,	1.0 ),
			new SkillInfo( 15, "Discordance",		        0.0,	0.0,	0.0,	"Demoralizer",		null,	0.0,	0.005,	0.005,	1.0 ),
			new SkillInfo( 16, "Evaluating Intelligence",	0.0,	0.0,	0.0,	"Scholar",	        null,	0.0,	0.0,	0.01,	1.0 ),
			new SkillInfo( 17, "Healing",			        0.0,	0.0,	0.0,	"Healer",	        null,	0.0,	0.005,	0.005,	1.0 ),
			new SkillInfo( 18, "Fishing",			        0.0,	0.0,	0.0,	"Fisherman",	    null,	0.005,	0.005,	0.0,	1.0 ),
			new SkillInfo( 19, "Forensic Evaluation",	    0.0,	0.0,	0.0,	"Detective",	    null,	0.0,	0.0,	0.01,	1.0 ),
			new SkillInfo( 20, "Herding",			        0.0,	0.0,	0.0,	"Shepherd",	        null,	0.005,	0.005,	0.0,	1.0 ),
			new SkillInfo( 21, "Hiding",			        0.0,	0.0,	0.0,	"Shade",	        null,	0.0,	0.01,	0.0,	1.0 ),
			new SkillInfo( 22, "Provocation",		        0.0,	0.0,	0.0,	"Rouser",		    null,	0.0,	0.005,	0.005,	1.0 ),
			new SkillInfo( 23, "Inscription",		        0.0,	0.0,	0.0,	"Scribe",	        null,	0.0,	0.0,	0.01,	1.0 ),
			new SkillInfo( 24, "Lockpicking",		        0.0,	0.0,	0.0,	"Infiltrator",	    null,	0.0,	0.01,	0.0,	1.0 ),
			new SkillInfo( 25, "Magery",			        0.0,	0.0,	0.0,	"Mage",		        null,	0.0,	0.0,	0.01,	1.0 ),
			new SkillInfo( 26, "Resisting Spells",	        0.0,	0.0,	0.0,	"Warder",		    null,	0.0,	0.0,	0.01,	1.0 ),
			new SkillInfo( 27, "Tactics",			        0.0,	0.0,	0.0,	"Warrior",	        null,	0.005,	0.005,	0.0,	1.0 ),
			new SkillInfo( 28, "Snooping",			        0.0,	0.0,	0.0,	"Spy",	            null,	0.0,	0.01,	0.0,	1.0 ),
			new SkillInfo( 29, "Musicianship",		        0.0,	0.0,	0.0,	"Bard",		        null,	0.0,	0.005,	0.005,	1.0 ),
			new SkillInfo( 30, "Poisoning",			        0.0,	0.0,	0.0,	"Assassin",	        null,	0.0,	0.01,	0.0,	1.0 ),
			new SkillInfo( 31, "Archery",			        0.0,	0.0,	0.0,	"Archer",	        null,	0.005,	0.005,	0.0,	1.0 ),
			new SkillInfo( 32, "Spirit Speak",		        0.0,	0.0,	0.0,	"Medium",	        null,	0.0,	0.0,	0.01,	1.0 ),
			new SkillInfo( 33, "Stealing",			        0.0,	0.0,	0.0,	"Pickpocket",	    null,	0.0,	0.01,	0.0,	1.0 ),
			new SkillInfo( 34, "Tailoring",			        0.0,	0.0,	0.0,	"Tailor",	        null,	0.0,	0.005,	0.005,	1.0 ),
			new SkillInfo( 35, "Animal Taming",		        0.0,	0.0,	0.0,	"Tamer",	        null,	0.005,	0.005,	0.0,	1.0 ),
			new SkillInfo( 36, "Taste Identification",	    0.0,	0.0,	0.0,	"Praegustator",		null,	0.0,	0.0,	0.005,	1.0 ),
			new SkillInfo( 37, "Tinkering",			        0.0,	0.0,	0.0,	"Tinker",	        null,	0.005,	0.005,	0.0,	1.0 ),
			new SkillInfo( 38, "Tracking",			        0.0,	0.0,	0.0,	"Ranger",	        null,	0.0,	0.005,	0.005,	1.0 ),
			new SkillInfo( 39, "Veterinary",		        0.0,	0.0,	0.0,	"Veterinarian",	    null,	0.0,	0.005,	0.005,	1.0 ),
			new SkillInfo( 40, "Swordsmanship",		        0.0,	0.0,	0.0,	"Swordsman",	    null,	0.005,	0.005,	0.0,	1.0 ),
			new SkillInfo( 41, "Mace Fighting",		        0.0,	0.0,	0.0,	"Armsman",	        null,	0.005,	0.005,	0.0,	1.0 ),
			new SkillInfo( 42, "Fencing",			        0.0,	0.0,	0.0,	"Fencer",	        null,	0.005,	0.005,	0.0,	1.0 ),
			new SkillInfo( 43, "Wrestling",			        0.0,	0.0,	0.0,	"Wrestler",	        null,	0.005,	0.005,	0.0,	1.0 ),
			new SkillInfo( 44, "Lumberjacking",		        0.0,	0.0,	0.0,	"Lumberjack",	    null,	0.01,	0.0,	0.0,	1.0 ),
			new SkillInfo( 45, "Mining",			        0.0,	0.0,	0.0,	"Miner",	        null,	0.01,	0.0,	0.0,	1.0 ),
			new SkillInfo( 46, "Meditation",		        0.0,	0.0,	0.0,	"Stoic",	        null,	0.0,	0.0,	0.01,	1.0 ),
			new SkillInfo( 47, "Stealth",			        0.0,	0.0,	0.0,	"Rogue",	        null,	0.0,	0.01,	0.0,	1.0 ),
			new SkillInfo( 48, "Remove Trap",		        0.0,	0.0,	0.0,	"Trap Specialist",	null,	0.0,	0.01,	0.0,	1.0 ),				
		};
	...
	public class Skills : IEnumerable
	{
		...
		public void OnSkillChange( Skill skill )
		{
            ...
            if (ns != null)
            {
                Mobile mobile = m_Owner;
 
                if (!mobile.HideSkillUpdates)
