...
namespace Server.Network
{
	public class PacketReader
	{
		...
		public StringBuilder ReadUnicodeStringSafe()
		{
			StringBuilder sb = new StringBuilder();
		...
		public StringBuilder ReadUTF8StringSafe()
		{
			if ( m_Index >= m_Size )
				return null;
			...
			StringBuilder s = new StringBuilder(Utility.UTF8.GetString( buffer ));
		...
		public StringBuilder ReadStringSafe()
		{
			StringBuilder sb = new StringBuilder();
