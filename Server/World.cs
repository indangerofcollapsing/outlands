...
namespace Server
{
    public static class World
    {
        ...
        public static void Load()
        {
            ...
            bool failedMobiles = false, failedItems = false;
            ...
            if (failedItems || failedMobiles)
            {
                ...
                throw new Exception(String.Format("Load failed (items={0}, mobiles={1}, type={2}, serial={3})", failedItems, failedMobiles,  failedType, failedSerial), failed);
            }
